...
from process.reader.util import BaseReader
from process.util import WindowArg


class AwsSentinelUnstackReader(BaseReader):
    band_filenames = ["B01.tif", "B02.tif", "B03.tif", "B04.tif", "B05.tif", "B06.tif",
                      "B07.tif", "B08.tif", "B8A.tif", "B09.tif", "B11.tif", "B12.tif"]

    def __init__(self, folder_path: str):
        self.folder_path = folder_path
        self.datas, self.profiles, self.window_transforms, self.resolutions = self.read_data_and_profile_and_window_transform()
    ...
    def get_window_arg_in_factor(self, window_arg: WindowArg, factor: int):
    ...
    def crop_data(self, window_arg_in_min_resolution: WindowArg, output_folder: str):
